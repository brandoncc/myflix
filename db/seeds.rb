...
Video.create(title: 'Breaking Bad - Pilot',
             ...
             'after his death.',
             small_cover: '/covers/breaking_bad_small.jpg',
             large_cover: '/covers/breaking_bad_large.jpg',
             category: drama
             )
...
Video.create(title: 'Dexter - Dexter',
             ...
             'two.',
             small_cover: '/covers/dexter_small.jpg',
             large_cover: '/covers/dexter_large.jpg',
             category: drama
             )
...
sons_of_anarchy = Video.create(title: 'Sons of Anarchy - Pilot',
                               ...
                               'prematurely.',
                               small_cover: '/covers/sons_of_anarchy_small.jpg',
                               large_cover: '/covers/sons_of_anarchy_large.jpg',
                               category: drama
                               )
...
Video.create(title: 'Game of Thrones - Winter is Coming',
             ...
             small_cover: '/covers/game_of_thrones_small.jpg',
             large_cover: '/covers/game_of_thrones_large.jpg',
             category: drama
             )
...
Video.create(title: 'Homeland - Pilot',
             ...
             small_cover: '/covers/homeland_small.jpg',
             large_cover: '/covers/homeland_large.jpg',
             category: drama
             )
...
Video.create(title: 'Sherlock - A Study in Pink',
             ...
             small_cover: '/covers/sherlock_small.jpg',
             large_cover: '/covers/sherlock_large.jpg',
             category: drama
             )
...
Video.create(title: '30 Rock - Pilot',
             ...
             small_cover: '/covers/30_rock_small.jpg',
             large_cover: '/covers/30_rock_large.jpg',
             category: comedy
             )
...
the_big_bang_theory = Video.create(title: 'The Big Bang Theory - Pilot',
                                   ...
                                   small_cover: '/covers/the_big_bang_theory_small.jpg',
                                   large_cover: '/covers/the_big_bang_theory_large.jpg',
                                   category: comedy
                                   )
...
american_idol = Video.create(title: 'American Idol - Auditions #1 - Boston & Austin',
                             ...
                             small_cover: '/covers/american_idol_small.jpg',
                             large_cover: '/covers/american_idol_large.jpg',
                             category: reality
                             )
...
Video.create(title: 'American Dad - Pilot',
             ...
             "his fix.",
             small_cover: '/covers/american_dad_small.jpg',
             large_cover: '/covers/american_dad_large.jpg',
             category: comedy
             )

...
Video.create(title: 'Breaking Bad - Pilot',
             ...
             'after his death.',
             small_cover: File.open(File.join(Rails.root, '/public/covers/breaking_bad_small.jpg')),
             large_cover: File.open(File.join(Rails.root, '/public/covers/breaking_bad_large.jpg')),
             category: drama
             )
...
Video.create(title: 'Dexter - Dexter',
             ...
             'two.',
             small_cover: File.open(File.join(Rails.root, '/public/covers/dexter_small.jpg')),
             large_cover: File.open(File.join(Rails.root, '/public/covers/dexter_large.jpg')),
             category: drama
             )
...
sons_of_anarchy = Video.create(title: 'Sons of Anarchy - Pilot',
                               ...
                               'prematurely.',
                               small_cover: File.open(File.join(Rails.root, '/public/covers/sons_of_anarchy_small.jpg')),
                               large_cover: File.open(File.join(Rails.root, '/public/covers/sons_of_anarchy_large.jpg')),
                               category: drama
                               )
...
Video.create(title: 'Game of Thrones - Winter is Coming',
             ...
             small_cover: File.open(File.join(Rails.root, '/public/covers/game_of_thrones_small.jpg')),
             large_cover: File.open(File.join(Rails.root, '/public/covers/game_of_thrones_large.jpg')),
             category: drama
             )
...
Video.create(title: 'Homeland - Pilot',
             ...
             small_cover: File.open(File.join(Rails.root, '/public/covers/homeland_small.jpg')),
             large_cover: File.open(File.join(Rails.root, '/public/covers/homeland_large.jpg')),
             category: drama
             )
...
Video.create(title: 'Sherlock - A Study in Pink',
             ...
             small_cover: File.open(File.join(Rails.root, '/public/covers/sherlock_small.jpg')),
             large_cover: File.open(File.join(Rails.root, '/public/covers/sherlock_large.jpg')),
             category: drama
             )
...
Video.create(title: '30 Rock - Pilot',
             ...
             small_cover: File.open(File.join(Rails.root, '/public/covers/30_rock_small.jpg')),
             large_cover: File.open(File.join(Rails.root, '/public/covers/30_rock_large.jpg')),
             category: comedy
             )
...
the_big_bang_theory = Video.create(title: 'The Big Bang Theory - Pilot',
                                   ...
                                   small_cover: File.open(File.join(Rails.root, '/public/covers/the_big_bang_theory_small.jpg')),
...
american_idol = Video.create(title: 'American Idol - Auditions #1 - Boston & Austin',
                             ...
                             small_cover: File.open(File.join(Rails.root, '/public/covers/american_idol_small.jpg')),
                             large_cover: File.open(File.join(Rails.root, '/public/covers/american_idol_large.jpg')),
                             category: reality
                             )
...
Video.create(title: 'American Dad - Pilot',
             ...
             "his fix.",
             small_cover: File.open(File.join(Rails.root, '/public/covers/american_dad_small.jpg')),
             large_cover: File.open(File.join(Rails.root, '/public/covers/american_dad_large.jpg')),
             category: comedy
             )
